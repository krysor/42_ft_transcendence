...
function NavBar(props) {
	return (
		...
		<Container>
			...
			{!props.isLoggedIn && <Nav.Link as={Link} to="/signup">Signup</Nav.Link>}
			{!props.isLoggedIn && <Nav.Link as={Link} to="/login">Login</Nav.Link>}
			{props.isLoggedIn && <Nav.Link as={Link} to="/logout">Logout</Nav.Link>}
			</Nav>
			{props.isLoggedIn &&
			<Nav.Link as={Link} to="/profile">
				{props.user && props.user.profile_pic && <ProfilePic filename={props.user.profile_pic} />}
			</Nav.Link>}
		</Container>
		</Navbar>
	)
