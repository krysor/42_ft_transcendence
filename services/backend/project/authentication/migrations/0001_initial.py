# Generated by Django 5.0 on 2024-05-22 13:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player1_id', models.IntegerField(default=0, verbose_name='ID of player 1')),
                ('player1_name', models.CharField(default='', max_length=255, verbose_name='Name of player 1')),
                ('player2_id', models.IntegerField(default=0, verbose_name='ID of player 2')),
                ('player2_name', models.CharField(default='', max_length=255, verbose_name='Name of player 2')),
                ('date', models.DateField(verbose_name='date of the match')),
                ('player1_score', models.IntegerField(default=0, verbose_name='score of player 1')),
                ('player2_score', models.IntegerField(default=0, verbose_name='score of player 2')),
                ('winner_id', models.IntegerField(default=0, verbose_name='ID of the winner')),
                ('winner_name', models.CharField(default='', max_length=255, verbose_name='Name of the winner')),
